const leatherColors = [
    ...
    { img: 'images/WHISKEY BUTTON.png', display: 'images/WHISKEY LEATHER2-20.png' },
...
/* Engraving text update vertical */

const verticalTextInput = document.getElementById("verticalTextInput");
const verticalTextPreview = document.getElementById("verticalTextPreview");

verticalTextInput.addEventListener("input", () => {
  verticalTextPreview.textContent = verticalTextInput.value;
});
